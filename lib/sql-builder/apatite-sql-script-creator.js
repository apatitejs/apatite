...
const ApatiteSQLStatement = require('../database-statement/apatite-select-sql-statement')
...
class ApatiteSQLScriptCreator {
    ...
    createStatementForTableExistence(tableName) {
        const bindVariables = []
        const sqlStr = this.apatite.dialect.buildSQLForTableExistence(tableName, bindVariables)
        return new ApatiteSQLStatement(null, sqlStr, bindVariables)
    }

    createStatementForTableColumnExistence(tableName, columnName) {
        const bindVariables = []
        const sqlStr = this.apatite.dialect.buildSQLForTableColumnExistence(tableName, columnName, bindVariables)
        return new ApatiteSQLStatement(null, sqlStr, bindVariables)
    }
